// Sign-up page — loads Clerk dynamically with a value-prop split layout
"use client";
import dynamic from "next/dynamic";
import Link from "next/link";
import { CheckCircle, Sparkles, FileText, Shield } from "lucide-react";

const ClerkSignUp = dynamic(() => import("@clerk/nextjs").then((m) => ({ default: m.SignUp })), { ssr: false });

const perks = [
  "Generate 26 UK document types",
  "HMRC-compliant payslips & P45s",
  "ERA 2025 Day-One Rights ready",
  "PDF & Word downloads",
        ...
        <div>
          ...
          <div className="max-w-md">
            <h2 className="text-2xl font-bold text-white">
              UK employment documents — in seconds, not days
            </h2>
            <p className="mt-3 text-sm text-gray-400 leading-relaxed">
              Join 500+ UK businesses using DocuHive to generate compliant contracts,
              payslips, staff handbooks, and more. No solicitor. No HR suite. No headache.
            </p>
